...
#define KEY1        HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_11)  //KEY1按键PE11
#define KEY2        HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_12) //KEY2按键PE12
#define YAOT        HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_0) //KEY2按键PE12
#define DINGS        HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1) //KEY2按键PE12
